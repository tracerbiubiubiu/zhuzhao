...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "github_com_tracerbiubiubiu_zhuzhao_internal_model.ReplaceTypeFieldsRequest": {
            ...
            "properties": {
                "code": {
                    "description": "W1（BK-18 整改）：code 从 path param 迁入 body",
                    "type": "string"
                },
                "fields": {
                    "type": "array",
                ...
                "version": {
                    "description": "Version 可选乐观锁：以父类型 ticket_types.version 做 CAS；nil = 不做 CAS。\n须 \u003e 0，否则 400。",
                    "type": "integer"
                }
            }
        },
        ...
        "github_com_tracerbiubiubiu_zhuzhao_internal_model.UpdateTicketTypeRequest": {
            ...
            "properties": {
                "code": {
                    "description": "W1（BK-18 整改）：code 从 path param 迁入 body（POST 风格，standards §3-2）",
                    "type": "string"
                },
                "description": {
                    "type": "string"
