...
| 迁移 | Phase 3 迁移编号启动时按 A2 规则重排（当前 000001–000022 已占用，下一编号 **000023**；000020–000022 = 判定日志/job_submissions/任务菜单） |
