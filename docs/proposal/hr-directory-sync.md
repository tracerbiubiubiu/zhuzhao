# HR 目录同步与虚拟组挂载
>
> **状态：活跃 SSOT（M-HR HR 同步设计源；§3.2/§4.3 三拍板项待 M-HR 启动确认）**
...
> **2026-08-26 P2-D7 调整**：本方案的 **HR Sync Job 实现降为 2b-ext 延后**（Phase 2 组织数据以种子/手工维护）；其 Schema 已随 2b-org 落地（迁移 000012）。
>
> 创建日期：2026-08-14
