# 方案总览
>
> **状态：方案期入口（2026-08-12）；各专项方案状态见各文件头。Phase 1/2 已按此落地交付；Phase 3 主线经 2026-09-02 重定位（§23），以 phase3/13 为准**
...
**企业内部 IAM（身份与访问管理）+ 工单统一平台**（定位锚点见 [VISION](../VISION.md)）。提供用户管理、组织架构、角色权限、动态路由等基础能力，并以工单为首个业务模块。
