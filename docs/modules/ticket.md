...
>
> **⚠ 封版注记（2026-09-02，design-decisions §23）**：工单**自研暂缓**（对接公司内部平台/引擎），Phase 2 现状封版——本文件描述的已交付能力保持准确；未实现的演进设计（SLA/审批流等）转**对接参考**（[phase3/10-ticket-business.md](../phase3/10-ticket-business.md)），翻案条件见 §23。
>
> 创建日期：2026-08-12
