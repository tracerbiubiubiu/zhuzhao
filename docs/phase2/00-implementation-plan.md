...
| 2026-08-31（夜） | §9 登记 **BK-14**（成员 scope 配置面：关系派拍板、scope=all 仅全局管理员可授、防提权复用 ensureCanManageMember，与 BK-13 同批实施）；外部 review 验证收口：**AGENTS.md 遗留节校准**（TC2/HC2 标已修、TC1 改「脚本已覆盖/Go 层缺」）、11 §6 TC1 口径修正、11 §8 增 **A7**（TC1-Go 测试）+ W1 升级为「BK-13+BK-14 场景闭环」 |
